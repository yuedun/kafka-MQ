...
var client = new kafka_node_1.KafkaClient({ kafkaHost: config_js_1.kafkaMQ.kafka }); //多个地址用逗号分割
var toKafka = /** @class */ (function () {
    ...
    toKafka.prototype.produce = function (key, message, callback) {
        ...
        var payloads = [
            { topic: 'arrange-lesson', messages: new kafka_node_1.KeyedMessage(key, this.msg) }
        ];
